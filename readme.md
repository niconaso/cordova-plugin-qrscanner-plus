...
<!-- Does your project use cordova-plugin-qrscanner-plus? We'd love to share a screenshot of your scanning interface! Please send a pull request adding your screenshot to the list below. -->
...
```bash
cordova plugin add cordova-plugin-qrscanner-plus
```
...
There are two primary steps to integrating `cordova-plugin-qrscanner-plus`.
...
## Typescript
Type definitions for cordova-plugin-qrscanner-plus are [available in the DefinitelyTyped project](https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/cordova-plugin-qrscanner/cordova-plugin-qrscanner.d.ts).
...
This will create a new cordova project in the `cordova-plugin-test-projects` directory next to this repo, install `cordova-plugin-qrscanner-plus`, and configure the [Cordova Plugin Test Framework](https://github.com/apache/cordova-plugin-test-framework). Once the platform tests are generated, the following commands are available:
